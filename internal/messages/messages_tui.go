...
func init() {
	...
	lang.Register(lang.Russian, map[string]string{
		...
		"tui.section.saved.label":    "Сохраненные серверы",
		"tui.section.saved.desc":     "Адреса, сохраненные для быстрого повторного использования.",
		"tui.section.recent.label":   "Недавние адреса",
		"tui.section.recent.desc":    "Адреса, введенные недавно, с их последним результатом.",
		...
		"tui.section.settings.desc":  "Войти или выйти, очистить сохраненные данные или сбросить featured-когорту.",

		// Confirmation prompts.
		"tui.confirm.logout":         "Очистить сохраненный вход?",
		"tui.confirm.clearAddrs":     "Очистить сохраненные и недавние адреса?",
		...
		"tui.settings.clearAddrs.label":     "Очистить сохраненные и недавние",
		"tui.settings.clearAddrs.desc":      "Забыть сохраненные серверы и недавние адреса.",
		...
		"tui.settings.signOut.desc":         "Забыть сохраненный токен Xbox и franchise-сессию.",

		// Transient notes (confirmations / errors shown inline).
		"tui.note.resolved":            "определено: %s",
		"tui.note.noResolved":          "сейчас ни один адрес не определен",
		"tui.note.signedIn":            "вход выполнен",
		"tui.note.signInIncomplete":    "вход не завершен",
		"tui.note.forgot":              "забыто %s",
		"tui.note.saved":               "сохранено %s",
		"tui.note.savedAddr":           "сохранено %s",
		"tui.note.languageChanged":     "Язык переключен на %s",
		...
		"tui.note.clearedAddrs":        "сохраненные и недавние очищены",
		...
		"tui.note.noAddrEntry":         "для этой записи нет сохраненного адреса - нажмите d, чтобы ее забыть",
		...
		"tui.decryptHelp.noAddr":      "Ключи на месте, но паков нет, и нет сохраненного адреса для повторной загрузки.",
